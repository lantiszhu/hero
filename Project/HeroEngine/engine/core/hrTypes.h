...
#ifndef __HERO_TYPES_H_INCLUDED__
#define __HERO_TYPES_H_INCLUDED__
...
#define MAKE_IRR_ID(c0, c1, c2, c3) \
		((hero::uint32)(hero::u8)(c0) | ((hero::uint32)(hero::u8)(c1) << 8) | \
		((hero::uint32)(hero::u8)(c2) << 16) | ((hero::uint32)(hero::u8)(c3) << 24 ))

#if defined(__BORLANDC__) || defined (__BCPLUSPLUS__)
#define _strcmpi(a,b) strcmpi(a,b)
#endif

#endif // __HERO_TYPES_H_INCLUDED__
