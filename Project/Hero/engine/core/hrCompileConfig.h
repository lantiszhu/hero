...
#ifndef __HERO_COMPILE_CONFIG_H_INCLUDED__
#define __HERO_COMPILE_CONFIG_H_INCLUDED__
...
//! _IRR_WINDOWS_ for all hrlicht supported Windows versions
...
//! Define _IRR_USE_NON_SYSTEM_JPEG_LIB_ to let hrlicht use the jpeglib which comes with hrlicht.
...
//! Define _IRR_USE_NON_SYSTEM_LIBPNG_ to let hrlicht use the libpng which comes with hrlicht.
...
file named 'hr_dbg_shader_%%.vsh' or 'hr_dbg_shader_%%.psh' will be created. Drag'n'drop
...
/** .hr scenes using ISceneManager::loadScene */
...
//! Define _IRR_COMPILE_WITH_IRR_MESH_LOADER_ if you want to load Irrlicht Engine .hrmesh files
...
//! Define _IRR_COMPILE_WITH_IRR_WRITER_ if you want to write static .hrMesh files
...
//! Define __HERO_COMPILE_WITH_ZIP_ARCHIVE_LOADER_ if you want to open ZIP and GZIP archives
/** ZIP reading has several more options below to configure. */
#define __HERO_COMPILE_WITH_ZIP_ARCHIVE_LOADER_
#ifdef NO__HERO_COMPILE_WITH_ZIP_ARCHIVE_LOADER_
#undef __HERO_COMPILE_WITH_ZIP_ARCHIVE_LOADER_
#endif
#ifdef __HERO_COMPILE_WITH_ZIP_ARCHIVE_LOADER_
...
#endif
//! Define _IRR_USE_NON_SYSTEM_ZLIB_ to let hrlicht use the zlib which comes with hrlicht.
...
#endif
//! Define _IRR_USE_NON_SYSTEM_BZLIB_ to let hrlicht use the bzlib which comes with hrlicht.
...
//! Define __HERO_COMPILE_WITH_MOUNT_ARCHIVE_LOADER_ if you want to mount folders as archives
#define __HERO_COMPILE_WITH_MOUNT_ARCHIVE_LOADER_
#ifdef NO__HERO_COMPILE_WITH_MOUNT_ARCHIVE_LOADER_
#undef __HERO_COMPILE_WITH_MOUNT_ARCHIVE_LOADER_
#endif
//! Define __HERO_COMPILE_WITH_PAK_ARCHIVE_LOADER_ if you want to open ID software PAK archives
#define __HERO_COMPILE_WITH_PAK_ARCHIVE_LOADER_
#ifdef NO__HERO_COMPILE_WITH_PAK_ARCHIVE_LOADER_
#undef __HERO_COMPILE_WITH_PAK_ARCHIVE_LOADER_
#endif
//! Define __HERO_COMPILE_WITH_NPK_ARCHIVE_LOADER_ if you want to open Nebula Device NPK archives
#define __HERO_COMPILE_WITH_NPK_ARCHIVE_LOADER_
#ifdef NO__HERO_COMPILE_WITH_NPK_ARCHIVE_LOADER_
#undef __HERO_COMPILE_WITH_NPK_ARCHIVE_LOADER_
#endif
//! Define __HERO_COMPILE_WITH_TAR_ARCHIVE_LOADER_ if you want to open TAR archives
#define __HERO_COMPILE_WITH_TAR_ARCHIVE_LOADER_
#ifdef NO__HERO_COMPILE_WITH_TAR_ARCHIVE_LOADER_
#undef __HERO_COMPILE_WITH_TAR_ARCHIVE_LOADER_
#endif
//! Define __HERO_COMPILE_WITH_WAD_ARCHIVE_LOADER_ if you want to open WAD archives
#define __HERO_COMPILE_WITH_WAD_ARCHIVE_LOADER_
#ifdef NO__HERO_COMPILE_WITH_WAD_ARCHIVE_LOADER_
#undef __HERO_COMPILE_WITH_WAD_ARCHIVE_LOADER_
#endif
...
// Irrlicht build, *and* in the user application, before #including <hrlicht.h>
...
//! Define __HERO_HAS_S64 if the hero::s64 type should be enable (needs long long, available on most platforms, but not part of ISO C++ 98)
#define __HERO_HAS_S64
#ifdef NO__HERO_HAS_S64
#undef __HERO_HAS_S64
#endif

#endif // __HERO_COMPILE_CONFIG_H_INCLUDED__
