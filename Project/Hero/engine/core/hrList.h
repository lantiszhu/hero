...
#ifndef __HERO_LIST_H_INCLUDED__
#define __HERO_LIST_H_INCLUDED__
...
public:
	...
	public:
		...
		Iterator  operator + (int32 num) const { Iterator tmp = *this; return tmp += num; }
		Iterator& operator -=(int32 num) { return (*this)+=(-num); }
		Iterator  operator - (int32 num) const { return (*this)+ (-num); }
	...
	public:
		...
		ConstIterator  operator + (int32 num) const { ConstIterator tmp = *this; return tmp += num; }
		ConstIterator& operator -=(int32 num) { return (*this)+=(-num); }
		ConstIterator  operator - (int32 num) const { return (*this)+ (-num); }
...
private:
	...
	SKListNode* Last;
	uint32 Size;
	hrAllocator<SKListNode> allocator;
